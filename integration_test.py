#!/usr/bin/env python3
"""
Full Integration Test for Authentication Flows
...
class AuthIntegrationTester:
    ...
    def run_full_flow(self):
        ...
        if not verify_after_reg:
            print("❌ Verification after registration failed")
            return False
        ...
        if not verify_after_login:
            print("❌ Verification after login failed")
            return False
        ...
        if not verify_after_refresh:
            print("❌ Verification after refresh failed")
            return False
