...
import os
import sys
sys.path.insert(0, 'F:/Q4-hakathons/Q4-hackathon2-todo/phase3-chatbot/backend')
...
def migrate_database():
    ...
    with Session(engine) as session:
        ...
        for legacy_todo in legacy_todos:
            ...
            from src.models.task import PriorityLevel
            priority_map = {
...
def verify_migration():
    ...
    with Session(engine) as session:
        ...
        if canonical_users > 0:
            ...
            if sample_user:
                print(f"  Sample user: {sample_user.username} ({sample_user.id})")
